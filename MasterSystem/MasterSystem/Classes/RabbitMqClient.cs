...
{
    public class RabbitMqSyncModule
    {
        /// <summary>
        /// Название обменника
        /// </summary>
        ...
        public RabbitMqSyncModule(string exchangeName, string queueName, string routingKey)
        {
        ...
        public RabbitMqSyncModule(string queueName) : this(
            String.Empty, 
            queueName, 
            string.Empty)
        {
